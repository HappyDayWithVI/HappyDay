...
var SerieManager = (function () {
    function SerieManager(httpmanagerService) {
        this.httpmanagerService = httpmanagerService;
    }
    SerieManager.prototype.getSerie = function (data) {
        return this.httpmanagerService.get('tvshow/search' + data.message);
    };
    return SerieManager;
}());
SerieManager = __decorate([
    core_1.Injectable(),
    __metadata("design:paramtypes", [http_manager_1.HttpManagerService])
], SerieManager);
exports.SerieManager = SerieManager;
//# sourceMappingURL=serie.manager.js.map